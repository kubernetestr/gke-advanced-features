...
podTemplate(label: label, containers: [
    ...
    node(label) {
        ...
        stage('Ace CD') {
            ...
            container('gcloud'){
                sh  "sed -i -e 's/#VERSION#/${IMAGETAG}/g' ./cicd/jenkins/docker-hello-world-spring-boot/k8s/deployment.yaml"
                sh  "sed -i -e 's/#PROJECTID#/${PROJECT_ID}/g' ./cicd/jenkins/docker-hello-world-spring-boot/k8s/deployment.yaml"
            ...
            sh """
                ...
                kubectl apply -n frontend -f ./cicd/jenkins/docker-hello-world-spring-boot/k8s
                kubectl rollout status -n frontend deploy/frontend
               """
            }
        }
      }
